...
5. If there are many-to-many relationships, you'll need **joining tables** to make it into a logical model. 

*This description leaves out quite a bit of detail, so just make your own assumptions about how it should be modelled.*
...
- [Pen and paper](https://www.amazon.co.uk/paper-pens/s?k=paper+and+pens) - Pen and paper are an excellent combination! Don't make it too scribbly though or I won't be able to read it.

Icing/ketchup/blood/cheddar are poor choices and should only be used in an emergency. If that sounds like a weird thing to say it's maybe because you weren't at the lecture on Monday, and also it's an objectively weird thing to say anyway.

## Anything to submit?
There's no mandatory submission here, but please do hunt me down (gently) during the lab for feedback. If I don't get a chance to see you, you can email your diagram to me (drough001@dundee.ac.uk).  

## Anything else?
<img src="uni.jpg" class="floaters">

If you're done with that and want some more practice (it's all helpful for your first assignment!), try this out - it's a bit more complex but I have faith in you :pray: :
...
- Staff members may teach on various modules

---
<div style="font-size:11px">
*There is actually no such thing as a good morning. All classes before noon are inherently bad and I'm sorry it has to be this way.
</div>
&nbsp

<div style="font-size:8px">
If you are reading this then congratulations! Decrypt the following message and tell me the answer first and you will win a prize that I haven't figured out yet:
Zkdw lv wkh rqob XV vwdwh wkdw grhv qrw frqwdlq dqb ohwwhuv iurp wkh zrug "Pdfnhuho"?
</div>